...
public class PruebaA {
    public static void main(String[] args) {
        ...
        Money eurAmount = CurrencyConverterMAVEN.convert(usd1, eur, exchangeRate);
        ...
        System.out.println("Suma: " + CurrencyConverterMAVEN.addMoney(usd1, usd2));

        // Resta usd1 a usd2 y muestra el resultado de la resta
        System.out.println("Resta: " + CurrencyConverterMAVEN.subtractMoney(usd1, usd2));

        // Compara usd1 a usd2 y muestra el resultado de la comparación
        System.out.print("Comparación: " + usd1 + " es ");
        int compare = CurrencyConverterMAVEN.compareAmounts(usd1, usd2);
        if (compare == 0) {
